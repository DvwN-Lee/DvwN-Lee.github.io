...
export const cloudNativeV2Content = {
    ...
    actions: [
        ...
        '<strong>k6 부하 테스트 기반 성능 최적화</strong>: k6 스크립트로 실제와 유사한 트래픽 시나리오 기반의 부하 테스트를 진행했습니다. 테스트 결과 드러난 병목 현상을 기반으로 HPA의 임계값을 정밀하게 튜닝하여 Phase 1 개선으로 <strong>P99 Latency 94% 감소(3.71s → 238ms)</strong>, 5xx 에러를 완전 제거하고 안정적인 트래픽 처리 용량을 확보했습니다.'
    ],
    ...
    results: [
        ...
        '<strong>정량적 성능 개선</strong>: HPA 최적화를 통해 부하 상황에서 <strong>P99 Latency 94% 감소(3.71s → 238ms)</strong>, 5xx 에러를 완전 제거하고 Grafana 실측 <strong>P95 9.77ms / P99 19.8ms</strong>, k6 부하 테스트(100 VU) <strong>P95 74.76ms / 에러율 0.01%</strong>의 시스템 안정성을 달성했습니다.',
    ...
    modal: {
        ...
        keyFeatures: [
            ...
            '<strong>성능 부하 테스트 및 최적화</strong>: k6 부하 테스트 기반 HPA 튜닝으로 P99 Latency 94% 감소(3.71s → 238ms), 5xx 에러 완전 제거'
        ],
        ...
        learningPoints: [
            ...
            '<strong>데이터 기반 성능 최적화</strong>: k6 부하 테스트로 시스템의 병목을 정량적으로 분석하고, HPA 튜닝을 통해 P99 Latency 94% 감소(3.71s → 238ms) 및 5xx 에러 완전 제거를 달성했습니다.'
        ]
    }
};
